...
from SigmaMusic import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
...
from SigmaMusic.utils.database import is_video_allowed
...
from SigmaMusic.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from SigmaMusic.utils.inline.playlist import botplaylist_markup
...
@app.on_callback_query(
    filters.regex("SigmaPlaylists") & ~BANNED_USERS
)
@languageCB
